...
% more example: get data for July
mon=7;
TMP_July=squeeze(TMP_reshape(:,:,mon,:));
...
% framem;
% gridm;
title('Surface air temperature trend, 1948-2020');
...
framem;
% gridm;
title('Surface annual air temperature trend, 1948-2020');
